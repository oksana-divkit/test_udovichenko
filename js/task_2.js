...
function initMap() {
  ...
  map.addListener('click', function(e) {
    ...
    const url='http://api.geonames.org/countryCodeJSON?lat=' + e.latLng.lat() + '&lng=' + e.latLng.lng() +'&username=ks_rew';
...
function handleClickCity() {
    ...
    const url='http://api.geonames.org/searchJSON?q=' + cityName + '&maxRows=1&lang=en&username=ks_rew&style=full';
